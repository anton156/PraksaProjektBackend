...
namespace PraksaProjektBackend.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task<dynamic> SendReservedQrEmailAsync(IFluentEmail mailer, string eventname, string usermail)
        {
            //var email = new MimeMessage();
            //email.Sender = MailboxAddress.Parse(_mailSettings.Mail);
            //email.To.Add(MailboxAddress.Parse(usermail));
            ...
            var email = mailer
                        ...
                        .UsingTemplateFromFile($"{Directory.GetCurrentDirectory()}/wwwroot/TemplateEmail/TemplateReserved.cshtml",
                    new
                    {
                        Subject = eventname,
                    });
